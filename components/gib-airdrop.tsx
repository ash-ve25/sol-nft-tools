  ...
  useEffect(() => {
    try {
      ...
      if (previousKey) {
        ...
        setWallet(wallet);
        setCreator(c);
        localStorage.setItem('airdrop-privkey', JSON.stringify(Array.from(keypair.secretKey)));
      }
    } catch (e) {
      notification.open({
