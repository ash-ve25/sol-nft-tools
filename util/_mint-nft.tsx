...
import { sendTransactionWithRetry, WalletSigner } from "../contexts";
import {
  StringPublicKey,
  programIds,
  toPublicKey,
...
export const mintNFT = async (
  ...
  console.log({ wallet, txId: metadataFile?.transactionId });
...
*/
    ...
    const transferTxId = await sendTransactionWithRetry(
      connection,
      wallet,
